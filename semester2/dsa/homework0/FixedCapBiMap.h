...
public:
	...
	FixedCapBiMapIterator iterator();

	// destructor
	~FixedCapBiMap();

	//trebuie sa stearga cheia resp. valori pt cheie
	//trb sa stearga toate val pt cheia resp k
	//sa returneze valorile care apartin acelei chei
	//2 valori => valuePair
	//1 valoare asociata - 1 comp- valoarea, a 2 a componenta - null
	// nicio valoare asociata - ambele valori din valuePair sunt null
	//cel mai simplu fac cu metoda search si apoi fac remove-ul
